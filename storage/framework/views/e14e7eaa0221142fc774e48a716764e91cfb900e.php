        ...
        <section class="container text-center" style="width: 20vw; margin-top: 5vh;">
            ...
            <?php echo csrf_field(); ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="full_price" id="full_price" value="50" readonly required>
                </div>
                ...
                <div style="padding-top: 5vh;">
                    ...
                    <div class="form-check">
                        ...
                        <input class="form-check-input" type="radio" name="payment" id="payment_on_spot">
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\laravel-apartmani\resources\views/reservation-page.blade.php ENDPATH**/ ?>