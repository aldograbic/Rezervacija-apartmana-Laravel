        ...
        <section class="sadrzaj_kontejner">
            ...
            <section id="apartmani_sadrzaj">
                <section id="galerija_slika_apartmani">
                    <img class="img-thumbnail" src="{{ asset('img/slika1.jpg') }}">
                    <img class="img-thumbnail" src="{{ asset('img/slika2.jpg') }}">
                    <img class="img-thumbnail" src="{{ asset('img/slika3.jpg') }}">
                    <img class="img-thumbnail" src="{{ asset('img/slika4.jpg') }}">
                    <img class="img-thumbnail" src="{{ asset('img/slika5.jpg') }}">
                    <img class="img-thumbnail" src="{{ asset('img/slika6.jpg') }}">
                </section>
                
                <section id="opis_apartmani" style="margin-left: 0.5vw;">
                    <h1>{{ $apartment->name }}</h1>
                    <h2>Opis</h2>
                    <p style="max-width: 60vw; padding-bottom: 5vh;"> Veličina: {{ $apartment->apartment_size }} m&sup2 <br>  Balkon: @if ($apartment->balcony == 1) ima @else nema @endif <br> Broj soba: {{ $apartment->number_of_rooms }} <br> Broj kreveta: {{ $apartment->number_of_beds }}
                     <br>Ljubimci: @if ($apartment->pets == 1) dopušteni @else nedopušteni @endif <br></p>
                    <h2>Sadržaj</h2>
                    <section id="sadrzaj_lista">
                        ...
                        <ul class="list-group" style="width: 20vw; padding-bottom: 2vh;">
                            ...
                            <li class="list-group-item">Wi-Fi @if ($apartment->wifi == 1) &#10004; @else &#10005;  @endif</li>
                            <li class="list-group-item">klima @if ($apartment->air_conditioning == 1) &#10004; @else &#10005;  @endif</li>
                        </ul>                        
                    </section>      
                </section>
                <section class="text-center" style="margin-bottom: 5vh;">
                    <p>Cijena po noći: {{ $apartment->price }} &euro;</p>
                    @if (Auth::check())
                    <a class="btn btn-outline-primary" href="{{ route('reservation', ['id' => $apartment->id]) }}">Rezerviraj</a>
                    @else
                    <a class="btn btn-outline-primary" href="{{ route('login') }}">Prijavite se za rezervaciju</a>
                    @endif
                </section>
            </section>    
        </section>
